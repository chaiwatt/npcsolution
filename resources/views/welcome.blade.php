...
<head>
        ...
        <!-- off canvas css -->
        {{-- <link rel="stylesheet" type="text/css" href="{{asset('assets/website/css/off-canvas.css')}}"> --}}
        <!-- magnific popup css -->
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/website/css/extend.css')}}">
        <!--[if lt IE 9]>
    ...
    <body class="defult-home">
                                            ...
                                            <nav class="rs-menu pr-90 md-pr-0">
                                               <ul id="onepage-menu" class="nav-menu">
                                                   <li class="current-menu-item">
                                                       <a href="#rs-header">หน้าแรก</a>
                                                   </li>
                                                   <li>
                                                       <a href="#rs-about">บริการ</a>
                                                   </li>
                                                   <li>
                                                       <a href="#rs-services">ลูกค้าของเรา</a>
                                                   </li>
                                                   <li>
                                                       <a href="#rs-blog">บทความ</a>
                                                   </li>
                                                   <li>
                                                       <a href="#rs-contact">ติดต่อ</a>
                                                   </li>
                                               </ul> <!-- //.nav-menu -->
                                            </nav>                                         
                                        </div> <!-- //.main-menu -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="services-item">
                                ...
                                <div class="services-content">
                                    <h2 class="title"><a href="web-development.html">Warranty Management IT</a></h2>
                                    <p class="desc">
                        ...
                        <div class="col-md-4">
                            <div class="services-item active">
                                ...
                                <div class="services-content">
                                    <h2 class="title"><a href="web-development.html">Product Control Services</a></h2>
                                    <p class="desc">
                                        We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms.
                                    </p>
                                    <div class="services-btn2">
                        ...
                        <div class="col-md-4">
                            <div class="services-item">
                                ...
                                <div class="services-content">
                                    <h2 class="title"><a href="web-development.html">Quality Control System</a></h2>
                                    <p class="desc">
                                        We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms.
                                    </p>
                                    <div class="services-btn2">
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/1.jpg')}}" alt=""></a>
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/2.jpg')}}" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/3.jpg')}}" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/4.jpg')}}" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/5.jpg')}}" alt=""></a>
                                <ul class="post-categories">
                        ...
                        <div class="blog-item">
                            <div class="image-wrap">
                                <a href="#"><img src="{{asset('assets/website/images/blog/main-home/6.jpg')}}" alt=""></a>
                                <ul class="post-categories">
                                    <li><a href="blog-details.html">It Services</a></li>
                                </ul>
                            </div>
        ...
        <!-- op nav js -->
        {{-- <script src="{{asset('assets/website/js/jquery.nav.js')}}"></script> --}}
        <!-- Time Circle js -->
        {{-- <script src="{{asset('assets/website/js/time-circle.js')}}"></script> --}}
        <!-- owl.carousel js -->
        <script src="{{asset('assets/website/js/owl.carousel.min.js')}}"></script>
        <!-- wow js -->
        <script src="{{asset('assets/website/js/wow.min.js')}}"></script>
        <!-- Skill bar js -->
        {{-- <script src="{{asset('assets/website/js/skill.bars.jquery.js')}}"></script>
        ...
        <!-- pointer js -->
        <script src="{{asset('assets/website/js/pointer.js')}}"></script> --}}
        <!-- contact form js -->
